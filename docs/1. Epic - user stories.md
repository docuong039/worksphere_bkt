...
| **US-MNG-01-15** | Là PM, tôi muốn **Import danh sách task** từ file Excel/CSV, hỗ trợ cả các cột thông tin cơ bản và các cột **Custom Fields** của dự án, để khởi tạo dữ liệu nhanh chóng.                                               | _Bổ sung mới_               |
...
| **US-CEO-04-02** | Là CEO/Chủ tịch, tôi muốn lọc Activity theo **dự án / phòng ban (nếu có) / nhân sự / loại sự kiện**, để đánh giá vận hành nhanh. | _Bổ sung mới_               |
...
| **US-ORG-03-04** | _(Đã bỏ - Chuyển sang MNG-01-10)_                                                                                                                |               |
