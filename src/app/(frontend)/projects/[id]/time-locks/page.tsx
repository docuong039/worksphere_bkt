            ...
            <div className="max-w-5xl mx-auto pb-20 animate-in fade-in duration-700" data-testid="time-locks-container">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                    <div className="space-y-2">
                        ...
                        <h1 className="text-3xl font-black text-slate-900 tracking-tight" data-testid="time-locks-title">
                            Khóa kỳ công (Work Period Locks)
                        </h1>
                        <p className="text-slate-500 font-medium">Quản lý các khoảng thời gian bị giới hạn ghi nhận và chỉnh sửa dữ liệu.</p>
                    </div>

                    <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                        <DialogTrigger asChild>
                            <Button className="bg-blue-600 hover:bg-blue-700 h-11 px-6 font-bold shadow-lg shadow-blue-100" data-testid="create-lock-btn">
