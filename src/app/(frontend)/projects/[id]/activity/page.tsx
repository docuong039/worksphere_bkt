...
export default function ProjectActivityPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-700 pb-20" data-testid="project-activity-container">
            {/* Header */}
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h2 className="text-xl font-black text-slate-800 tracking-tight flex items-center gap-2" data-testid="project-activity-title">
            ...
            <Card className="border-none shadow-sm bg-white mb-8">
                <CardContent className="p-4 flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <Select value={typeFilter} onValueChange={setTypeFilter}>
                        <SelectTrigger className="w-full md:w-48 h-10 bg-slate-50 border-none rounded-xl font-bold" data-testid="activity-type-select">
                            <SelectValue placeholder="Loại hoạt động" />
                        </SelectTrigger>
                        <SelectContent>
                            <SelectItem value="ALL" data-testid="activity-type-all">Tất cả hoạt động</SelectItem>
                            <SelectItem value="CREATE" data-testid="activity-type-create">Tạo mới</SelectItem>
                            <SelectItem value="UPDATE" data-testid="activity-type-update">Cập nhật</SelectItem>
                            <SelectItem value="COMMENT" data-testid="activity-type-comment">Bình luận</SelectItem>
                            <SelectItem value="STATUS_CHANGE" data-testid="activity-type-status">Trạng thái</SelectItem>
                            <SelectItem value="TIME_LOG" data-testid="activity-type-timelog">Ghi nhận giờ</SelectItem>
                        </SelectContent>
                    </Select>
                </CardContent>
            </Card>
            ...
            <div className="relative">
                ...
                <div className="space-y-8 relative" data-testid="activity-list">
                    {loading ? (
                        ...
                        filteredActivities.map((activity) => (
                            <div key={activity.id} className="flex flex-col md:flex-row gap-6 group">
                                <div className="relative z-10 shrink-0 flex items-center justify-center md:block">
                                    <Avatar className="h-12 w-12 border-4 border-white shadow-sm ring-1 ring-slate-100">
                                ...
                                <div className="flex-1 space-y-2 md:pt-1">
                                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                                        <div className="flex items-center flex-wrap gap-x-2 gap-y-1">
                                            ...
                                            <Badge variant="secondary" className="bg-blue-50 text-blue-700 border-none font-bold text-[10px] uppercase">
                                    ...
                                    <Card className="border-none shadow-sm bg-white/50 backdrop-blur-sm group-hover:bg-white transition-colors duration-300">
                                        <CardContent className="p-4 flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="text-xs">
                                                    ...
                                                    <p className="text-slate-500 mt-0.5">ID: {activity.entity_id}</p>
                                                </div>
                                            </div>
                                            <Button variant="ghost" size="sm" className="rounded-lg h-8 px-3 font-bold text-blue-600" asChild>
                                                <Link href={`/tasks/${activity.entity_id}`}>Chi tiết</Link>
                                            </Button>
                                        </CardContent>
                                    </Card>
                                </div>
