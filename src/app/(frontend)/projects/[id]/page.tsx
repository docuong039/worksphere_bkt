...
export default function ProjectTasksPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <PermissionGuard permission={PERMISSIONS.PROJECT_READ} showFullPageError>
            <div className="space-y-6 animate-in fade-in duration-500 pb-10" data-testid="project-tasks-container">
                {/* Header - now using shared layout, just show task-specific context if needed */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h2 className="text-xl font-black tracking-tight text-slate-800" data-testid="project-tasks-title">
                            Quản lý Công việc
                        </h2>
                    </div>
