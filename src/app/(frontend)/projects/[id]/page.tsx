                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm text-left border-collapse">
                                <thead className="bg-slate-50/50 text-slate-400 font-bold uppercase tracking-widest text-[10px]">
                                    <tr>
                                        {isPM && <th className="px-6 py-4 w-12 text-center">Xếp</th>}
                                            ...
                                            {isPM && (
                                                <td className="px-6 py-4">
                                                    <div className="flex flex-col gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                                                        <Button variant="ghost" size="icon" onClick={() => handleReorder(task.id, 'UP')} className="h-6 w-6"><ChevronUp size={14} /></Button>
                                                        <Button variant="ghost" size="icon" onClick={() => handleReorder(task.id, 'DOWN')} className="h-6 w-6"><ChevronDown size={14} /></Button>
                                                    </div>
                                                </td>
                                            )}
