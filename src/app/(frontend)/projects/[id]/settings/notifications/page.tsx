...
export default function NotificationSettingsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <AppLayout>
            <div className="space-y-6 animate-in fade-in duration-700" data-testid="notification-settings-page">
                {/* Header */}
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <Button variant="ghost" asChild className="-ml-4 mb-2 text-slate-500">
                        ...
                        <p className="text-slate-500 mt-1 font-medium">
                            Thiết lập thông báo cho dự án (US-MNG-07-03)
                        </p>
                    </div>
                    <Button
