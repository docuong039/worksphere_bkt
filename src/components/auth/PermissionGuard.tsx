        ...
        if (showFullPageError) {
            return (
                <div
                    ...
                    data-testid="permission-error-container"
                >
                    ...
                    <div className="mt-12 pt-8 border-t border-slate-100 w-full max-w-xs">
                        ...
                        <code
                            className="text-[10px] bg-slate-50 text-slate-600 px-2 py-1 rounded mt-2 inline-block font-mono border border-slate-100"
